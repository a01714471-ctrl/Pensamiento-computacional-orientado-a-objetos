...
A este programa se le realizaron las siguientes modificaciones:
  ...
  5. Impemento composición (o agregación) sieguiendo mi diagrama de clases, que pertenece a la sub-competencia de Implementa SICT0303A, el cambio se puede observar en los archivos League.h, Conference.h y Team.h, en todos los atributos que están definidos por valor dentro de las clases.
